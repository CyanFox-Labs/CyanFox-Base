        ...
        <div>
            <span class="rounded-md shadow-sm">
                <button
                    ...
                    type="button"
                    class="bg-base-100 inline-flex justify-center px-4 py-2 w-full text-sm font-medium rounded-md border border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:border-gray-600 "
                    aria-haspopup="true"
            ...
            <div class="bg-base-100 rounded-md shadow-xs">
                ...
                >
                    <div wire:key="{{ $tableName }}-columnSelect-selectAll-{{ rand(0,1000) }}">
                        ...
                        >
                            <input
                                class="bg-base-200 text-indigo-600 transition duration-150 ease-in-out border-gray-300 rounded shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:border-gray-600 disabled:opacity-50 disabled:cursor-wait"
                                wire:loading.attr="disabled"
                                type="checkbox"
                    ...
                    @foreach ($component->getColumnsForColumnSelect() as $columnSlug => $columnTitle)
                        ...
                        >
                            ...
                            >
                                <input
                                    class="bg-base-200 text-indigo-600 rounded border-gray-300 shadow-sm transition duration-150 ease-in-out focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:border-gray-600 disabled:opacity-50 disabled:cursor-wait"
