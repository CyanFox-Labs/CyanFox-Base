    ...
    >
        <button
            @class([
                ...
                'bg-base-100 inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 text-sm font-medium hover:bg-gray-50 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:border-gray-600 dark:hover:bg-gray-600' => $component->isTailwind(),
            ])
            type="button"
        ...
        @if($component->isTailwind())
            <div
                ...
                class="bg-base-100 origin-top-right absolute right-0 mt-2 w-full md:w-48 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-50"
            >
                    ...
                    <div class="py-1" role="menu" aria-orientation="vertical">
                        @foreach ($component->getBulkActions() as $action => $title)
                            <button
                                ...
                                type="button"
                                class="block w-full px-4 py-2 text-sm leading-5 hover:bg-base-200 focus:outline-none focus:bg-gray-100 focus:text-gray-900 flex items-center space-x-2"
                                role="menuitem"
                            >
                                <span>{{ $title }}</span>
                            </button>
