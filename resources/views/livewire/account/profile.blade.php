    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        @if($tab == 'overview')
            <div class="col-span-1 space-y-4">
                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        <span
                            class="font-bold text-xl">{{ __('messages.language') }} / {{ __('messages.theme') }}</span>
                        <div class="divider"></div>
                        <div class="form-control w-full">
                            <label class="label" for="language">
                                <span
                                    class="label-text font-bold">{{ __('pages/account/profile.select_language') }}</span>
                            </label>
                        ...
                        <div class="form-control w-full">
                            ...
                            <select class="select select-bordered" id="theme"
                                    wire:blur="changeTheme($event.target.value)">
                                <option value="light"
        ...
        @if($tab == 'api_keys')
            <div class="col-span-3 space-y-4">
                <div class="card bg-base-100 col-span-1 lg:col-span-2 shadow-xl">
                    <div class="card-body">
                        <span class="font-bold text-xl">{{ __('pages/account/profile.api_keys') }}</span>
                        <div class="divider"></div>
