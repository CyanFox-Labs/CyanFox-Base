        ...
        <div class="text-sm breadcrumbs">
            <ul>
                ...
                <li><a href="{{ route('admin-user-create') }}"><i
                            class="bx bxs-plus-circle mr-2"></i> {{ __('breadcrumbs.admin.users.create') }}</a></li>
            </ul>
        </div>
    </div>
            ...
            <form onsubmit="event.preventDefault()">
                <div class="grid md:grid-cols-2 gap-4 mt-4">
                    <div class="form-control w-full">
                        <label class="label" for="first_name">
                            <span class="label-text">{{ __('pages/admin/users/user-create.first_name') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label" for="last_name">
                            <span class="label-text">{{ __('pages/admin/users/user-create.last_name') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label" for="username">
                            <span class="label-text">{{ __('pages/admin/users/user-create.username') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label" for="email">
                            <span class="label-text">{{ __('pages/admin/users/user-create.email') }}</span>
                        </label>
                ...
                <div class="grid md:grid-cols-2 gap-4 mt-4">
                    <div class="form-control w-full">
                        <label class="label" for="password">
                            <span class="label-text">{{ __('pages/admin/users/user-create.password') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full" wire:ignore>
                        <label class="label" for="roles">
                            <span class="label-text">{{ __('pages/admin/users/user-create.roles') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label" for="change_password">
                            <span class="label-text">{{ __('pages/admin/users/user-create.change_password') }}</span>
                        </label>
                    ...
                    <div class="form-control w-full">
                        <label class="label" for="activate_two_factor">
                            <span
                                class="label-text">{{ __('pages/admin/users/user-create.activate_two_factor') }}</span>
                        </label>
                ...
                <div class="col-span-1 mt-6 space-x-2 space-y-2">
                    ...
                    <button type="submit" wire:click="createUser"
                        ...
                        {{ __('pages/admin/users/user-create.create') }}
                    </button>
                </div>
            </form>
        </div>
