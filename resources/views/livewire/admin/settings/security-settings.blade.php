<div>
    <x-form wire:submit="updateSecuritySettings">
        @csrf
        <div class="mb-5">
            <x-select label="{{ __('admin/settings.security.password_minimum_length') }}"
        ...
        <div class="space-y-5">
            <x-checkbox label="{{ __('admin/settings.security.password_require_lowercase') }}"
                        wire:model="passwordRequireLowercase" class="checkbox-info" left tight/>

            <x-checkbox label="{{ __('admin/settings.security.password_require_uppercase') }}"
                        wire:model="passwordRequireUppercase" class="checkbox-info" left tight/>

            <x-checkbox label="{{ __('admin/settings.security.password_require_numbers') }}"
                        wire:model="passwordRequireNumbers" class="checkbox-info" left tight/>

            <x-checkbox label="{{ __('admin/settings.security.password_require_special_characters') }}"
