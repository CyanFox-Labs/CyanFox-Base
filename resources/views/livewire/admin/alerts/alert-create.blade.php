    ...
    <div class="ml-2 mb-5">
        <div class="text-sm breadcrumbs">
            <ul>
                ...
                <li><a href="{{ route('admin-alert-create') }}"><i
                            class="icon-plus-circle mr-2"></i> {{ __('navigation/breadcrumbs.admin.alerts.create') }}
                    </a></li>
            </ul>
        </div>
    </div>
            ...
            <form wire:submit="createAlert" onsubmit="sendToLivewire()">
                ...
                <div class="col-span-1 mt-6 space-x-2 space-y-2">
                    ...
                    <x-button type="submit"
                              class="btn btn-primary" spinner="createAlert">
                        {{ __('pages/admin/alerts/messages.buttons.create_alert') }}
                    </x-button>
                </div>
            </form>
        </div>
