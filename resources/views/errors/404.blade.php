...
<head>
    ...
    <title>404 | {{ __('pages/errors.codes.404') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">404</h1>
    <p class="error-description">{{ __('pages/errors.codes.404') }}</p>
</header>
<div class="status">
    <div class="card error" id="client-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.404') }}</p>
    </div>
...
<div class="reason">
    <div class="what-happened">
        ...
        <p class="description">{{ __('pages/errors.what_happened_descriptions.404') }}</p>
    </div>
    <div class="what-can-i-do">
        <h2>{{ __('pages/errors.what_can_i_do') }}</h2>
        <p class="description">{!! __('pages/errors.what_can_i_do_descriptions.404', ['here' => route('home')]) !!}</p>
    </div>
</div>
</body>
</html>
