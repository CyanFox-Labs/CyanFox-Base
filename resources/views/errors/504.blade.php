...
<head>
    ...
    <title>504 | {{ __('pages/errors.codes.504') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">504</h1>
    <p class="error-description">{{ __('pages/errors.codes.504') }}</p>
</header>
<div class="status">
    ...
    <div class="card error" id="server-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.504') }}</p>
    </div>
</div>
<div class="reason">
    <div class="what-happened">
        <h2>{{ __('pages/errors.what_happened') }}</h2>
        <p class="description">{{ __('pages/errors.what_happened_descriptions.504') }}</p>
    </div>
