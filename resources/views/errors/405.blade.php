...
<head>
    ...
    <title>405 | {{ __('pages/errors.codes.405') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">405</h1>
    <p class="error-description">{{ __('pages/errors.codes.405') }}</p>
</header>
<div class="status">
    <div class="card error" id="client-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.405') }}</p>
    </div>
...
<div class="reason">
    <div class="what-happened">
        ...
        <p class="description">{{ __('pages/errors.what_happened_descriptions.405') }}</p>
    </div>
