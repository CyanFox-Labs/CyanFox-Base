...
<head>
    ...
    <title>413 | {{ __('pages/errors.codes.413') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">413</h1>
    <p class="error-description">{{ __('pages/errors.codes.413') }}</p>
</header>
<div class="status">
    <div class="card error" id="client-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.413') }}</p>
    </div>
...
<div class="reason">
    <div class="what-happened">
        ...
        <p class="description">{{ __('pages/errors.what_happened_descriptions.413') }}</p>
    </div>
    <div class="what-can-i-do">
        <h2>{{ __('pages/errors.what_can_i_do') }}</h2>
        <p class="description">{!! __('pages/errors.what_can_i_do_descriptions.change_request', ['here' => route('home')]) !!}</p>
    </div>
</div>
</body>
</html>
