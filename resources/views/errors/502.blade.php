...
<head>
    ...
    <title>502 | {{ __('pages/errors.codes.502') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">502</h1>
    <p class="error-description">{{ __('pages/errors.codes.502') }}</p>
</header>
<div class="status">
    ...
    <div class="card error" id="server-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.502') }}</p>
    </div>
</div>
<div class="reason">
    <div class="what-happened">
        <h2>{{ __('pages/errors.what_happened') }}</h2>
        <p class="description">{{ __('pages/errors.what_happened_descriptions.502') }}</p>
    </div>
