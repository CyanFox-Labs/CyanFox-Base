...
<head>
    ...
    <title>403 | {{ __('pages/errors.codes.403') }}</title>
    <link rel="stylesheet" href="{{ asset('css/error.css') }}">
</head>
<body>
<header>
    <h1 class="error-code">403</h1>
    <p class="error-description">{{ __('pages/errors.codes.403') }}</p>
</header>
<div class="status">
    <div class="card error" id="client-status-card">
        ...
        <p class="status-text">{{ __('pages/errors.codes.403') }}</p>
    </div>
...
<div class="reason">
    <div class="what-happened">
        ...
        <p class="description">{{ __('pages/errors.what_happened_descriptions.403') }}</p>
    </div>
