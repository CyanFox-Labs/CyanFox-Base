...
return [
    'buttons' => [
        ...
        'deactivate_two_factor' => '2 Faktor deaktivieren',
        'change_password' => 'Passwort ändern',
    ],

    'notifications' => [
        'two_factor_enabled' => '2 Faktor wurde erfolgreich aktiviert.',
        'two_factor_disabled' => '2 Faktor wurde erfolgreich deaktiviert.',
