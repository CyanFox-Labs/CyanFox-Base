...
/*
 * Code from https://github.com/tallstackui/tallstackui/blob/1.x/src/Foundation/Console/SetupIconsCommand.php
 */
...
class SetupIconsCommand extends Command
{
    ...
    public $signature = 'cyanfox-base:setup-icons {--force : Install icons even when the icons are already installed}';
